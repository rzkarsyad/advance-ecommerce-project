            ...
            <div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder">
                        ...
                        <div class="tab-pane" id="category{{ $category->id }}">
                            <div class="product-slider">
                                <div class="owl-carousel home-owl-carousel custom-carousel owl-theme" data-item="4">
                                    ...
                                    ->whereBetween('created_at', [Carbon\Carbon::now()->subWeek()->format("Y-m-d H:i:s"), Carbon\Carbon::now()])->orderBy('id', 'DESC')->get();
                                    @endphp
                                    ...
                                    <!-- /.item -->
                                    @empty
                                    <h4 class="text-danger" style="margin-bottom: 20px;">No Product Found</h4>
                                    @endforelse
                                ...
                                <div class="product">
                                    ...
                                    <div class="cart clearfix animate-effect">
                                        <div class="action">
                                            <ul class="list-unstyled">
                                                <li class="add-cart-button btn-group">
                                                    <button class="btn btn-primary icon" type="button" title="Add Cart" data-toggle="modal" data-target="#exampleModal" onclick="productView(this.id)" id="{{ $product->id }}">
                                                        <i class="fa fa-shopping-cart"></i>
                                                    </button>
                                                    <button class="btn btn-primary cart-btn" type="button">Add to cart</button>
                                                </li>

                                                <button class="btn btn-primary icon" type="button" title="Add Wishlist" onclick="addToWishList(this.id)" id="{{ $product->id }}">
                ...
                <section class="section featured-product wow fadeInUp">
                    <h3 class="section-title">
                        @if (session()->get('language') == 'indonesia')
                        {{ $skip_category_0->category_name_id }}
                        @else
                ...
                <section class="section featured-product wow fadeInUp">
                    <h3 class="section-title">
                        @if (session()->get('language') == 'indonesia')
                        {{ $skip_category_1->category_name_id }}
                        @else
                ...
                <!-- ============================================== SKIP_0 BRAND PRODUCTS ============================================== -->
                <section class="section featured-product wow fadeInUp">
                    <h3 class="section-title">
                        @if (session()->get('language') == 'indonesia')
                        {{ $skip_brand_0->brand_name_id }}
                        @else
