                ...
                <div class="cnt-account">
                    <ul class="list-unstyled list-inline">
                        ...
                        <li>
                            @auth
                            <!-- Dropdown User -->
                            <!-- <li class="dropdown dropdown-small"> <a href="#" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown"><i class="icon fa fa-user"></i><span class="value">User Profile </span><b class="caret"></b></a>
                            <ul class="dropdown-menu">
                                <li><a style="color: black;" href="{{ route('user.profile') }}">{{ Auth::user()->name }}</a></li>
                                <li><a style="color: black;" href="{{ route('change.password') }}">Change Password</a></li>
                                <li><a style="color: black;" href="{{ route('user.logout') }}">Logout</a></li>
                            </ul>
                        </li> -->
                    ...
                    <ul class="list-unstyled list-inline">
                        ...
                        <li class="dropdown dropdown-small"> <a href="#" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                @else
                                <li><a href="{{ route('indonesia.lang') }}">Indonesia</a></li>
                                @endif
                            </ul>
                        </li>
                    </ul>
