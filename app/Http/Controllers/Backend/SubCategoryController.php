...
class SubCategoryController extends Controller
{
    ...
    public function SubCategoryStore(Request $request)
    {
        $request->validate(
            ...
            [
                ...
                'subcategory_name_id.required' => 'Input Sub Category Indonesia Name',
            ]
        );
    ...
    public function SubCategoryUpdate(Request $request)
    {
        ...
        SubCategory::findOrFail($subcat_id)->update([
            ...
            'subcategory_slug_id' => str_replace(' ', '-', 'subcategory_name_id'),
        ]);
    ...
    public function SubSubCategoryStore(Request $request)
    {
        $request->validate(
            ...
            [
                ...
                'subsubcategory_name_id.required' => 'Input Sub Category Indonesia Name',
            ]
        );
        ...
        SubSubCategory::insert([
            ...
            'subsubcategory_slug_id' => str_replace(' ', '-', 'subsubcategory_name_id'),
        ]);
